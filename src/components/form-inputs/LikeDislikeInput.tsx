  ...
  return (
    <div className="flex gap-2 sm:gap-4 justify-center flex-wrap">
      <button
        ...
        disabled={disabled}
        className={`like-dislike-button flex flex-col items-center gap-1.5 sm:gap-2 p-4 sm:p-6 rounded-lg border-2 min-w-[100px] sm:min-w-[120px] ${
          value === 1
      ...
      >
        ...
        <span className="font-medium text-sm sm:text-base">{likeLabel}</span>
      </button>
      ...
      >
        ...
        <span className="font-medium text-sm sm:text-base">{dislikeLabel}</span>
      </button>
    </div>
  );
}
